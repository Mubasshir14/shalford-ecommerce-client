                      ...
                      <div className="flex items-center gap-3">
                        <div className="flex items-center bg-amber-50 rounded-2xl p-2 shadow-inner">
                          ...
                          <Button
                            onClick={() => handleQuantityChange(item, -1)}
                            className="w-10 h-10 rounded-xl bg-white hover:bg-amber-100 text-amber-700 shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-110"
                            disabled={item.quantity <= item.product.minSell}
                          >
                            <Minus size={18} />
                          </Button>
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              ...
                              const min = item.product.minSell || 1;
                              const max =
                                item.product.maxSell;
                            ...
                            min={item.product.minSell}
                            max={item.product.maxSell}
                            className="w-16 text-center text-xl font-bold text-amber-700 bg-white border-x border-amber-200 rounded-md outline-none focus:ring-2 focus:ring-amber-400"
                          />
                          ...
                          <Button
                            onClick={() => handleQuantityChange(item, 1)}
                            className="w-10 h-10 rounded-xl bg-white hover:bg-amber-100 text-amber-700 shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-110"
                            disabled={item.quantity >= item.product.maxSell}
                          >
                            <Plus size={18} />
                          </Button>
                        </div>
