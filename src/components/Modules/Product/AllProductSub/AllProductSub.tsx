...
//       <h2 className="text-3xl font-bold mb-8 text-center text-amber-700 tracking-wide">
//         All Products
//       </h2>
...
//             height={300}
//             alt="Men"
//             className="rounded-xl shadow-lg object-cover bg-gradient-to-br from-amber-50/50 to-white group  overflow-hidden transform transition-all duration-500 hover:scale-105 hover:shadow-lg
//           "
//           />
//           <Image
//             src={women}
...
//             height={300}
//             alt="Unisex"
//             className="rounded-xl shadow-lg object-cover bg-gradient-to-br from-amber-50/50 to-white  group  overflow-hidden transform transition-all duration-500 hover:scale-105 hover:shadow-lg md:col-span-2 lg:col-span-1"
//           />
//         </div>
//         <div>
//           {loading ? (
...
//          <Link
//       href={'/products'}
//         className="bg-gradient-to-r from-amber-600 to-amber-700 text-white hover:from-amber-700 hover:to-amber-800 rounded-lg flex items-center justify-center gap-2 py-2.5 transition-all duration-300 group/button p-3"
