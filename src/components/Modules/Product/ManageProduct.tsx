...
// import { getAllProducts, deleteProduct } from "@/components/Services/Product";
...
//     const toastId = `deleting-product-${productId}`;
...
//       {/* Header */}
//       <div>
//         <h2 className="text-xl font-bold text-amber-600">Manage Products</h2>
