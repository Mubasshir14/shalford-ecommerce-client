...
export default function RelatedProductSubCard({ product }: ProductCardProps) {
  ...
  return (
    <div
      className="group relative rounded-lg transition-all duration-500 hover:-translate-y-2 border border-amber-200 hover:border-amber-300 shadow-sm hover:shadow-xl h-[350px] sm:w-[220px] lg:w-[245px] xl:w-[275px]"
    ...
    >
      ...
      <div className="px-3 pb-2 space-y-1 bg-amber-50/50 rounded-b-xl">
        <h3
          className="lg:text-md text-sm font-semibold text-amber-800 line-clamp-1 group-hover:text-amber-600 transition-colors duration-300 pt-2"
          title={product.name}
        >
          {product.name}
        </h3>
